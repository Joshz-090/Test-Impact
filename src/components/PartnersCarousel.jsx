...
const defaultLogos = [
  { src: partner1, alt: "Partner 1", href: "#" },
  { src: partner2, alt: "Partner 2", href: "#" },
  { src: partner3, alt: "Partner 3", href: "#" },
  { src: partner4, alt: "Partner 4", href: "#" },
  { src: partner5, alt: "Partner 5", href: "#" },
  { src: partner6, alt: "Partner 6", href: "#" },
  { src: partner7, alt: "Partner 7", href: "#" },
  { src: partner8, alt: "Partner 8", href: "#" },
  { src: partner9, alt: "Partner 9", href: "#" },
  { src: partner10, alt: "Partner 10", href: "#" },
  { src: partner11, alt: "Partner 11", href: "#" },
];
...
const PartnersCarousel = React.memo(function PartnersCarousel({
  ...
  // Keep a local state for image load errors to show fallback
  ...
  const handleImageError = (srcKey) => () =>
    setImageFailed((s) => ({ ...s, [srcKey]: true }));
      ...
      <div className="relative">
        ...
        <div className="overflow-hidden" ref={emblaRef}>
          <div className="flex touch-pan-y">
            {slides.map((logo, idx) => {
              const failed = imageFailed[logo.src] || false;
              return (
                <motion.div
                  key={`${logo.alt}-${idx}`}
                ...
                >
                  ...
                  >
                    <motion.div
                      ...
                      animate={{
                        scale: idx === selectedIndex ? 1.05 : 0.98,
                        opacity: idx === selectedIndex ? 1 : 0.9,
                      }}
                    ...
                    >
                      {!failed ? (
                        ...
                        <div className="mx-auto h-12 w-full rounded bg-gray-200" />
                      )}
                    </motion.div>
